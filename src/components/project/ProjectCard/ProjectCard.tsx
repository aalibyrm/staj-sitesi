      ...
      <Link className={styles.link} href={'/projects/' + project.slug} aria-label={project.title + ' projesini görüntüle'}>
        {project.coverImageUrl ? (
          <div className={styles.cover}>
            <Image src={project.coverImageUrl} alt={project.title + ' proje görseli'} fill sizes="(max-width: 760px) 100vw, (max-width: 1180px) 50vw, 33vw" loading="lazy" decoding="async" style={{ objectFit: 'contain' }} unoptimized />
          </div>
        ) : null}
